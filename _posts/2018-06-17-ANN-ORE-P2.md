...
<span style="color:red">Como a Oracle nos alerta, essa Máquina Virtual serve apenas para propósitos de testes, não tem suporte e não deve ser utilizada em ambientes de produção.</span>

**Importante:**
Caso ainda não o tenha em seu computador, você também precisará instalar o Oracle VM VirtualBox, para acomodar a VM, o qual pode ser obtido em: <sub>[http://www.oracle.com/technetwork/server-storage/virtualbox/downloads/index.html](http://www.oracle.com/technetwork/server-storage/virtualbox/downloads/index.html)</sub>
