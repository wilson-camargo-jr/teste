...
**Importante:**
Caso você ainda não tenha o **Oracle VM VirtualBox** instalado em seu computador, deverá instalar o mesmo para acomodar a VM, que pode ser obtido em:
<sub>
...
Na janela de diálogo que aparecerá, navegue para o local onde está o arquivo da VM (extensão .ova) e escolha Importar.
 ...
 ![Importação da VM](https://github.com/wilson-camargo-jr/wilson-camargo-jr.github.io/blob/master/img/impvm.jpg)

Tela de importação da VM de Banco de Dados.

  ![Importação da VM](https://github.com/wilson-camargo-jr/wilson-camargo-jr.github.io/blob/master/img/impvm2.jpg)
