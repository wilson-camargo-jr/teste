...
Para importar o arquivo, simplesmente de um “double-click” no arquivo OVA acima indicado ou alternativamente, selecione no menu do Virtual Box: Arquivo -> Importar Appliance.
