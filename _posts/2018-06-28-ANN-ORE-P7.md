...
Nosso modelo é composto por uma camada de input, duas camadas escondidas e uma camada de saída.

É na camada "densa" que é definida a estrutura, tamanho da entrada, da saída, o tipo de inicialiaçao dos pesos e implementada a operação de cálculo do pulso a ser enviado.
...
Normalmente, quanto menor o resultado de "loss" melhor o é modelo, exceto quando este estiver "overfitted".  
