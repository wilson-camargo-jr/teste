...
O modo mais fácil de realizar o Download dos arquivos necessários é acionar os links abaixo a partir do navegador web Firefox da pró
pria VM. 
...
Abra esse tutorial no Firefox da VM e tenha acesso direto aos arquivos.

2 -	Obtenha o arquivo de instalação do Oracle R Enterprise Server. São os arquivos **Server e Supporting - versão 1.5.1 para Linux-64-bit**. Os arquivos devem ser obtidos em:  
<sub><a href="http://download.oracle.com/otn/linux/ore/ore-server-linux-x86-64-1.5.1.zip" target="_blank">http://download.oracle.com/otn/linux/ore/ore-server-linux-x86-64-1.5.1.zip</a></sub>  
<sub><a href="http://download.oracle.com/otn/linux/ore/ore-supporting-linux-x86-64-1.5.1.zip" target="_blank">http://download.oracle.com/otn/linux/ore/ore-supporting-linux-x86-64-1.5.1.zip</a></sub>  
...
Após o download a pasta de instalação conterá os 2 arquivos compactados (.zip) abaixo:
...
<sub><a href="http://download.oracle.com/otn/linux/instantclient/122010/instantclient-basic-linux.x64-12.2.0.1.0.zip" target="_blank">http://download.oracle.com/otn/linux/instantclient/122010/instantclient-basic-linux.x64-12.2.0.1.0.zip</a></sub>
<sub><a href="http://download.oracle.com/otn/linux/instantclient/122010/instantclient-sdk-linux.x64-12.2.0.1.0.zip" target="_blank">http://download.oracle.com/otn/linux/instantclient/122010/instantclient-sdk-linux.x64-12.2.0.1.0.zip</a></sub>

1. **Aceite os termos de licenciamento**
2. **Para realizar o download você precisará ter uma conta no OTN**
3. **Caso não tenha basta criar em “Create Account” diretamente na página de login**
4. **Faça o download dos arquivos para a pasta de instalação, no nosso caso _/home/oracle/oreclient_**
...
<sub><a href="http://download.oracle.com/otn/linux/ore/ore-client-linux-x86-64-1.5.1.zip" target="_blank">http://download.oracle.com/otn/linux/ore/ore-client-linux-x86-64-1.5.1.zip</a></sub>
<sub><a href="http://download.oracle.com/otn/linux/ore/ore-supporting-linux-x86-64-1.5.1.zip" target="_blank">http://download.oracle.com/otn/linux/ore/ore-supporting-linux-x86-64-1.5.1.zip</a></sub>  
...
Agora a pasta de instalação conterá os novos arquivos compactado (zip) abaixo:

```
cd /home/oracle/oreclient  
ls -l
```
...
Deve retornar: /home/oracle/client
