...
Como estamos utilizando a mesma máquina para o Server e o Client, partiremos logo para a instalação do Oracle Database Client Software, que seria o passo **b)** em nossa sequencia de etapas listada acima. 
