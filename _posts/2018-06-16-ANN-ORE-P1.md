...
Nesse artigo vamos mostrar como implementar um Processo Analítico de Aprendizagem de Máquina chamado Artificial Neural Network (ANN) ou para quem preferir em portugês, Redes Neurais Artificiais (RNA), utilizando o Oracle R Enterprise (ORE) e a biblioteca Keras.
